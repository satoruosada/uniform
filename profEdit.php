...
if(!empty($_POST)){
  ...
  $pic = (empty($pic) && !empty($dbFormData['pic'])) ? $dbFormData['pic'] : $pic;//DBに登録されたもの、?新規登録されたもの、空の物
      ...
      <section id="main" >
        <div class="form-container">
          <form action="" method="post" class="form" enctype="multipart/form-data">
            ...
            プロフィール画像
            <label class="area-drop<?php if(!empty($err_msg['pic'])) echo 'err'; ?>" style="height:370px;line-height:300px;">
              <input type="hidden" name="MAX_FILE_SIZE" value="3145728">
              <input type="file" name="pic" class="input-file" style="height:300px;">
